...
$top_sales_query = "
    SELECT p.product_id, p.product_name, p.price, p.product_image, COUNT(o.product_id) AS sold_count
    FROM products p
                    ...
                    <ul class="top-sales-details">
                        ...
                        if ($top_sales_result->num_rows > 0) {
                            while ($row = $top_sales_result->fetch_assoc()) {
                                ...
                                $product_image = "images/" . $row['product_image']; // Assuming the image file is in the 'images' directory
                                ?>
                                <li>
                                    <a href="#">
