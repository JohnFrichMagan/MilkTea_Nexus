...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        $login_error = "Invalid staff email.";
    }
    $stmt->close();
    $conn->close();
}
...
<body>
    <div class="container">
        <div class="login-switch">
            <button onclick="window.location.href='admin_login.php'" class="switch-btn">Admin Login</button>
            <button onclick="window.location.href='staff_login.php'" class="switch-btn active">Staff Login</button>
        </div>
        ...
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <div class="form-group forgot-password">
                <a href="#">Forgot staff password?</a>
            </div>
            <div class="form-group">
        ...
        <div class="signup-link">
            Don't have a staff account? <a href="staff_register.php">Staff Signup</a>
        </div>
    </div>
